...
import vn.edu.hust.sis.khai225202.musicplayer.databinding.MusicViewBinding
...
class MusicAdapter(private val context: Context, private val musicList: ArrayList<Music>) :
    ...
    override fun onBindViewHolder(holder: MusicAdapter.MyHolder, position: Int) {
        ...
        Glide.with(context)
            ...
            .apply(RequestOptions().placeholder(R.drawable.sportify_icon_playstore).centerCrop())
            .into(holder.image)
